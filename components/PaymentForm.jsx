        ...
        <div className="min-w-screen min-h-screen bg-cyan-100 flex items-center justify-center px-5 pb-10 pt-16">
            <div className="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700 max-width-600px">
                <div className="w-full pt-1 pb-5">
                    <div className="bg-emerald-400 text-white overflow-hidden rounded-full w-20 h-20 -mt-16 mx-auto shadow-lg flex justify-center items-center">
                ...
                <div className="mb-3">
                    ...
                    <div>
                        <input className="w-full px-3 py-2 mb-1 border-2 border-orange-300 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" placeholder="John Smith" type="text" />
                    </div>
                </div>
                <div className="mb-3">
                    <label className="font-bold text-sm mb-2 ml-1">Card number</label>
                    <div>
                        <input className="w-full px-3 py-2 mb-1 border-2 border-orange-300 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" placeholder="0000 0000 0000 0000"maxLength='16' type="text" />
                    </div>
                </div>
                ...
                <div className='mb-10'>
                    ...
                    <div>
                        <input className="w-32 px-3 py-2 mb-1 border-2 border-orange-300 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" placeholder="000" type="text" />
                    </div>
                </div>
                <div>
