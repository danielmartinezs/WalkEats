...
const LoginForm = () => {
    ...
    return (
        <div>
            <section className=" bg-cyan-100 dark:bg-gray-900 rounded-2x1 py-2">
                <div className="flex items-center justify-center shadow-lg px-6 py-8 mx-auto max-h-fit lg:py-0">
