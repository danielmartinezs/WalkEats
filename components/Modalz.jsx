                    ...
                    <div className="relative w-full max-w-2xl max-h-full">
                        <div className="relative bg-orange-200 rounded-lg shadow dark:bg-emerald-700">
                            ...
                            <div className="flex flex-col justify-center items-center p-6 gap-2">
                                <span className='flex flex-col justify-center items-center text-lg text-emerald-700'>
                                    Subtotal de:{total}
                                </span>
                                ...
                                {showInput &&
                                    <div className='flex m-4'>
                                        <input placeholder='Ingresar monto a pagar' value={cobro} onChange={(e) => { setCobro(e.target.value) }} />
                                        <button type='button' className="text-white bg-primary-orange hover:bg-orange-400 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 w-full text-center focus:z-10 dark:bg-primary-green dark:hover:bg-emerald-700 dark:text-gray-300 dark:hover:text-white dark:border-gray-500">
                                            Confirmar
                                        </button>
                                    </div>}
                            </div>
